...
const Shoes = () => {
  ...
  const products = [
    { id: 1, name: "Running Sneakers", price: "$129", image: "👟", category: "Athletic", gradient: "from-green-400 to-emerald-600" },
    { id: 2, name: "Business Oxfords", price: "$199", image: "👞", category: "Formal", gradient: "from-gray-700 to-black" },
    { id: 3, name: "Casual Loafers", price: "$89", image: "🥿", category: "Casual", gradient: "from-brown-400 to-amber-600" },
    { id: 4, name: "High-Top Sneakers", price: "$109", image: "👟", category: "Street", gradient: "from-red-400 to-pink-600" },
    { id: 5, name: "Winter Boots", price: "$159", image: "🥾", category: "Outdoor", gradient: "from-orange-500 to-red-600" },
    { id: 6, name: "Summer Sandals", price: "$69", image: "👡", category: "Comfort", gradient: "from-blue-400 to-cyan-500" }
  ];
      ...
      <div className="pt-24 pb-16 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h1 className="text-5xl font-thin text-gray-900 mb-4 tracking-tight">Footwear Collection</h1>
            <p className="text-xl text-gray-600 font-light max-w-2xl mx-auto">
              Step into comfort and style with our AI-recommended shoe collection
            </p>
          </div>
